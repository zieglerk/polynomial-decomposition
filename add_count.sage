...
For comparison/testing, see the exact formula of BlankertzGathenZiegler and the "wild" Table 5.1 in Joachim's "Counting Decomposable Univariate Polynomials" with the exact values for \# D[n].
